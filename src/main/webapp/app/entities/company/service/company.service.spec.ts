...
describe('Company Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Company', () => {
      ...
      service.create(company).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Company', () => {
      ...
      service.update(company).subscribe(resp => (expectedResult = resp));
    ...
    it('should handle exceptions for searching a Company', () => {
    ...
    describe('addCompanyToCollectionIfMissing', () => {
      it('should add a Company to an empty array', () => {
        ...
        expect(expectedResult).toEqual([company]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([company, company2]);
      });
