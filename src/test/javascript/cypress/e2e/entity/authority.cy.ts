...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: 'edf45f4f-c7ab-435d-b4f7-354dd71807ac' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('7bbb575d-ec90-48ea-a503-4b141c658dd4');
      cy.get(`[data-cy="name"]`).should('have.value', '7bbb575d-ec90-48ea-a503-4b141c658dd4');
